...
export default function Teachers() {
  const API = "https://6923ebff3ad095fb84720700.mockapi.io/Teachers";
    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          ...
          className="bg-[#D4A8D6] text-[#1E1E2F] px-4 py-2 rounded-lg font-semibold"
        >
          + Add Teacher
        </button>
      </div>
          ...
          {data.map((item) => (
            ...
            >
              ...
              <div className="mt-3 flex justify-between items-center">
                <p className="font-bold">Profession: {item.profession}</p>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="bg-[#C084C1] text-white px-3 py-1 rounded-md text-sm"
                  >
                    Edit
                  </button>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50">
          <div className="bg-[#FDF0F5] p-6 rounded-xl w-[400px]">
            ...
            <div className="flex justify-end gap-3 mt-4">
              ...
              <button
                onClick={handleSave}
                className="px-4 py-2 bg-[#C084C1] text-white rounded"
              >
                Save
              </button>
            </div>
